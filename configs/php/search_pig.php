...
include "db.php";
$keyword = $connect->real_escape_string("%" . $_POST["keyword"] . "%");
$sql = "SELECT * FROM tbl_pigs LEFT JOIN tbl_breed ON tbl_pigs.breed=tbl_breed.breed_id LEFT JOIN tbl_cage ON tbl_pigs.cage_id=tbl_cage.cage_id LEFT JOIN tbl_batch ON  tbl_pigs.batch_id = tbl_batch.batch_id WHERE (tbl_pigs.pig_id like ?) and tbl_pigs.is_exist='true' ";
