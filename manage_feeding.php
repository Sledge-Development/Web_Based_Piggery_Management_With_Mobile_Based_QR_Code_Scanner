...
<head>
    ...
    <title>Manage Feeding Operation</title>
</head>

<body>
    <div id="view_feeding_details" class="w-screen hidden h-screen  shadow-2xl flex bg-black/50 overflow-hidden absolute">
        <div class="w-1/4 h-auto flex flex-col bg-white my-auto rounded-md mx-auto">
            <div class="w-full h-1/12 grid border-black border-b-2">
                <h1 class="text-center text-2xl my-auto">Feeding Details</h1>
            </div>
            <div class="w-full flex flex-col overflow-y-auto h-11/12 ">
                ...
                <div class="w-full h-auto mt-2 mb-2 flex flex-row">
                    ...
                    <span class="text-xl ml-2 my-auto">Grower Feeds</span>
                </div>
                <div class="w-full h-auto mt-2 mb-2 flex flex-row">
                    <span class="text-2xl my-auto ml-2 mr-4">Item Quantity:</span>
                    <span class="text-xl ml-2 my-auto">5 kg</span>
                </div>
                <div class="w-full h-auto mt-2 mb-2 flex flex-row">
    ...
    <div id="add_feeding_details" class="w-screen hidden  h-screen  flex bg-black/50 overflow-hidden absolute">
        <div class="w-1/4 bg-white shadow-2xl rounded-md h-3/4 flex flex-col   my-auto mx-auto">
            ...
            <div class="w-full flex overflow-y-auto flex-col h-11/12 ">
                ...
                <div class="w-full mb-2 h-12 flex flex-row">
                    <button class="w-1/4 h-full rounded-md bg-blue-500 hover:bg-red-400 mx-auto my-auto" id="confirm_add_feeding_details">Add </button>
                    <button class="w-1/4 h-full rounded-md bg-blue-500 hover:bg-red-400 mx-auto my-auto" id="cancel_add_feeding_details">Cancel </button>
                </div>
            </div>
        </div>
    </div>
    <div id="edit_feeding_details" class="w-screen hidden  h-screen  flex bg-black/50 overflow-hidden absolute">
        <div class="w-1/4 bg-white shadow-2xl rounded-md h-auto flex flex-col   my-auto mx-auto">
            <div class="w-full h-1/12 grid border-black border-b-2">
                <h1 class="text-center text-2xl my-auto">Edit Feeding Details</h1>
            </div>
            <div class="w-full flex overflow-y-auto flex-col h-11/12 ">
                <div class="w-full mt-2 mb-2 h-auto flex flex-col">
                    <span class="text-xl ml-12 my-auto">Pig Id:</span>
                ...
                <div class="w-full mb-2 h-12 flex flex-row">
                    <button class="w-1/4 h-full rounded-md bg-blue-500 hover:bg-red-400 mx-auto my-auto" id="confirm_edit_feeding_details">Add </button>
                    <button class="w-1/4 h-full rounded-md bg-blue-500 hover:bg-red-400 mx-auto my-auto" id="cancel_edit_feeding_details">Cancel </button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="h-11/12 w-full flex flex-row bg-gray-400">
            ...
            <div class="h-full w-5/6 flex flex-col bg-gray-600">
                <div class="w-full h-12 flex mt-2 flex-row">
                    <img class="w-12 h-12 mr-4 ml-8" src="assets/svg/feeding.png" alt="icon_user">
                    <h1 class="mt-auto text-white mb-auto font-bold">Feeding Management</h1>
                    ...
                    <button id="new_feeding_detail" class="mr-4 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">New
                        Feeding Operation
                    </button>
                </div>
...
<script src="assets/js/feeding_events.js"></script>
</html>